...
/* __string_template__9067adb685037108a3f7865b02af4ae81202e7f3c52e1e292b258dd1c0da4597 */
class __TwigTemplate_1126d7fb24576dce2fc57fb0f93ec4fa5c65c7ebd97bef4760e9649bf71a0401 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t<li><img alt=\"\" src=\"https://khoedeptainha.vn/FileUploads/imgfile/1(1).png\" style=\"color: rgb(255, 0, 0); width: 21px; height: 21px;\"> Đổi trả hàng trong 7 ngày</li>
        ...
        echo "\"/>
                                                ...
                                                <button style=\"width:30%;margin-left: 27%;margin-top: -9%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 272
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
        ...
        echo "</button>
                                                 <button style=\"width:30%;margin-left: 60%;margin-top: -9%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 274
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
...
";
    ...
    {
        return "__string_template__9067adb685037108a3f7865b02af4ae81202e7f3c52e1e292b258dd1c0da4597";
    }
...
/*                                                 */
/*                                                 <button style="width:30%;margin-left: 27%;margin-top: -9%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">{{ button_cart }}</button>*/
/*                                                  <button style="width:30%;margin-left: 60%;margin-top: -9%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">Đặt hàng nhanh</button>*/
/*                                             </div>*/
/*                                             {% if minimum > 1 %}*/
