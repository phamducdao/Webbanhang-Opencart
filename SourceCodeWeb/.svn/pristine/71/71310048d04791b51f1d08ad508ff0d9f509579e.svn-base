...
/* __string_template__3268748d54da6eb868453b210d7e28a4e5b42230dcbad8b212a9a23d98128647 */
class __TwigTemplate_af54ac326581dcd8340945a10f937f0f840335078f81f1f030b83f844a653dc1 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t<li><img alt=\"\" src=\"https://khoedeptainha.vn/FileUploads/imgfile/1(1).png\" style=\"color: rgb(255, 0, 0); width: 21px; height: 21px;\"> Đổi trả hàng trong 7 ngày</li>
        ...
        echo "\"/>
                                                ...
                                                <button style=\"width:30%;margin-left: 17%;margin-top: -9%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 272
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
        ...
        echo "</button>
                                                 <button style=\"width:30%;margin-left: 50%;margin-top: -9%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 274
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
...
";
    ...
    {
        return "__string_template__3268748d54da6eb868453b210d7e28a4e5b42230dcbad8b212a9a23d98128647";
    }
...
/*                                                 */
/*                                                 <button style="width:30%;margin-left: 17%;margin-top: -9%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">{{ button_cart }}</button>*/
/*                                                  <button style="width:30%;margin-left: 50%;margin-top: -9%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">Đặt hàng nhanh</button>*/
/*                                             </div>*/
/*                                             {% if minimum > 1 %}*/
