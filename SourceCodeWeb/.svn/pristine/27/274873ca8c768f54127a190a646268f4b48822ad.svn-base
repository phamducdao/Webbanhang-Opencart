...
/* __string_template__4c3e074a94a4ba8f53d270b41b11c501b29fefd4baaaacd8db0326832b0cdbb8 */
class __TwigTemplate_df9fe1f1af7238beb0265e7404672d48e321882d0b656938114b6b9eb36a427f extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t<li><img alt=\"\" src=\"https://khoedeptainha.vn/FileUploads/imgfile/1(1).png\" style=\"color: rgb(255, 0, 0); width: 21px; height: 21px;\"> Đổi trả hàng trong 7 ngày</li>
        ...
        echo "</label>
                                                <input style=\"width:25% ;\" type=\"text\" name=\"quantity\" value=\"";
        // line 268
        ...
        echo "\"/>
                                                ...
                                                <button style=\"width:30%\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 272
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
...
";
    ...
    {
        return "__string_template__4c3e074a94a4ba8f53d270b41b11c501b29fefd4baaaacd8db0326832b0cdbb8";
    }
...
/*                                                 <input style="width:25% ;" type="text" name="quantity" value="{{ minimum }}" size="2" id="input-quantity"*/
/*                                                        class="form-control" />*/
/*                                                 <input type="hidden" name="product_id" value="{{ product_id }}"/>*/
/*                                                 */
/*                                                 <button style="width:30%" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
