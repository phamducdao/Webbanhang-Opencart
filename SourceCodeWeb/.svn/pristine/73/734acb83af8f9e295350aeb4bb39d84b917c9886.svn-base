	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'news/category')) {
                $news[] = array(
                    'name'	   => $this->language->get('text_category'),
                    'href'     => $this->url->link('news/category', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'news/news')) {
                $news[] = array(
                    ...
                    'href'     => $this->url->link('news/news', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
