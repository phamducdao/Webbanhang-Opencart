...
/* __string_template__c0dffe8640a109d18a2c2399d0d50fcf7b9b4277e9e180a0916790924588a34e */
class __TwigTemplate_abbd8f1b49f456c069ef23b117c945d5a5da98b185d16e447b2290ebf160e4bb extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t<li><img alt=\"\" src=\"https://khoedeptainha.vn/FileUploads/imgfile/1(1).png\" style=\"color: rgb(255, 0, 0); width: 21px; height: 21px;\"> Đổi trả hàng trong 7 ngày</li>
        ...
        echo "\"/>
                                                ...
                                                <button style=\"width:30%;margin-left: 17%;margin-top: -7%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 272
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
        ...
        echo "</button>
                                                 <button style=\"width:36%;margin-left: 50%;margin-top: -6%;\" type=\"button\" id=\"button-cart\" data-loading-text=\"";
        // line 274
        echo (isset($context["text_loading"]) ? $context["text_loading"] : null);
        echo "\"
...
";
    ...
    {
        return "__string_template__c0dffe8640a109d18a2c2399d0d50fcf7b9b4277e9e180a0916790924588a34e";
    }
...
/*                                                 */
/*                                                 <button style="width:30%;margin-left: 17%;margin-top: -7%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">{{ button_cart }}</button>*/
/*                                                  <button style="width:36%;margin-left: 50%;margin-top: -6%;" type="button" id="button-cart" data-loading-text="{{ text_loading }}"*/
/*                                                         class="btn btn-primary btn-lg btn-block">Đặt hàng nhanh</button>*/
/*                                             </div>*/
/*                                             {% if minimum > 1 %}*/
